...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="teste@teste.com").fill("vitormanoelmb02@gm")
    page.get_by_role("textbox", name="teste@teste.com").press("Insert")
    page.get_by_role("textbox", name="teste@teste.com").fill("vitormanoelmb02@gmail.com")
    page.get_by_role("textbox", name="teste@teste.com").press("Tab")
    page.get_by_role("textbox", name="Sua senha secreta").fill("vitor0907")
    page.locator("#loginForm").get_by_role("button", name="Entrar").click()
    page.get_by_role("textbox", name="Sua senha secreta").click()
    page.get_by_role("textbox", name="Sua senha secreta").fill("vitor123")
